...
import com.szjlc.smt.ai.sdk.executor.model.gemini.valobj.Model;
...
public class CompletionRequest implements Serializable {
    ...
    public enum Model {
         ...
         * google palm
         */
        PALM_CHAT(com.szjlc.smt.ai.sdk.executor.model.google.config.Const.CHAT_MODEL_CODE),
        PALM_TEXT(com.szjlc.smt.ai.sdk.executor.model.google.config.Const.TEXT_MODEL_CODE),
        /**
         * google gemini-pro
         */
         ...
         * Gemini Pro
         */
        GEMINI_PRO(com.szjlc.smt.ai.sdk.executor.model.gemini.valobj.Model.GEMINI_PRO.getCode()),
        GEMINI_PRO_VERSION(com.szjlc.smt.ai.sdk.executor.model.gemini.valobj.Model.GEMINI_PRO_VERSION.getCode()),
        ;
        private final String code;
    }
